...
function createStockProvider(config) {
    async function getStocks(codes) {
        ...
        (0, capabilities_1.assertProviderFeatureSupported)(config.source, "quote");
    ...
    async function requestQuoteText(quote, apiCodes) {
        if ((0, browser_script_1.isBrowserRuntime)() && quote.browserRequestText) {
    ...
    const api = {
        ...
        async searchStocks(key) {
            (0, capabilities_1.assertProviderFeatureSupported)(config.source, "search");
...
async function requestSearchText(search, key) {
    if ((0, browser_script_1.isBrowserRuntime)() && search.browserRequestText) {
