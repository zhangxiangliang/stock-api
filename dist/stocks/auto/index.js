...
function getKlineProviders(autoProviders) {
    ...
    return [...autoProviders].sort((left, right) => {
        var _a, _b;
        return ((_a = order.get(left.name)) !== null && _a !== void 0 ? _a : Number.MAX_SAFE_INTEGER) -
            ((_b = order.get(right.name)) !== null && _b !== void 0 ? _b : Number.MAX_SAFE_INTEGER);
    });
}
