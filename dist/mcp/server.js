...
exports.supportedProtocolVersions = void 0;
...
exports.supportedProtocolVersions = ["2025-11-25", "2025-06-18"];
const latestProtocolVersion = exports.supportedProtocolVersions[0];
...
function isSupportedProtocolVersion(value) {
    return exports.supportedProtocolVersions.includes(value);
}
